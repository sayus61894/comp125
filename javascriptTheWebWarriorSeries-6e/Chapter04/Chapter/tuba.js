...
function verifyAcres() {
   ...
   try{
      ...
      validity = false;
      messageText = message;
      acresBox.value = ""; // removes invalid values
   }finally{
      acresComplete = validity;
      messageElement.innerHTML = messageText;
      messageHeadElement.innerHTML = ""; //remove former recommendation headings
...
function verifyMonths() {
   ...
   try{
      if(!(monthsBox.value >= 1 && monthsBox.value <= 12)){
         throw "Plase enter a number of months between 1 and 12."
